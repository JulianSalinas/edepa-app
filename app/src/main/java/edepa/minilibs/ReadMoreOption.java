...
public class ReadMoreOption {
    ...
    public static class Builder {
        ...
        private boolean expandAnimation = true;
        ...
        public Builder moreLabel(int moreLabel){
            this.moreLabel = context.getString(moreLabel);
            return this;
        }
        ...
        public Builder lessLabel(int lessLabel){
            this.lessLabel = context.getString(lessLabel);
            return this;
        }
        ...
        public Builder moreLabelColorRes(int moreLabelColor){
            this.moreLabelColor = context.getResources().getColor(moreLabelColor);
            return this;
        }
        ...
        public Builder lessLabelColorRes(int lessLabelColor){
            this.lessLabelColor = context.getResources().getColor(lessLabelColor);
            return this;
        }
