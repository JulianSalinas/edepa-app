 ...
 * de una manera más suave y con un impulso agregado
 */
public class SmoothLayout extends LinearLayoutManager {

    /**
     * Necesario para saber a que vista se le
     * agrega el efecto
     */
    ...
    /**
     * Coloca el scrooll en la vista. No es necesario llamar
     * esta función en otro lugar dentro del código, la vista
     * la usa de forma automática
     */
    @Override
    public void smoothScrollToPosition(RecyclerView view,
        ...
        LinearSmoothScroller scroller = new LinearSmoothScroller(context) {
            ...
            /*
             * Esto sirve para mover la vista hasta el último
             * elemento agregado. Por ejemplo, el chat o las noticias
             * donde la cantidad de elementos se actualiza
             */
            @Override
            ...
            /**
             * Calcula la velocidad del scroll según las dimensiones
             * de la pantalla
             */
            @Override
