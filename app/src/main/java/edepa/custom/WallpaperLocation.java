...
public enum WallpaperLocation {
    ...
    TIERRA_MEDIA("(((labo?r?a?t?o?r?i?o?)|(aula)|(laimi?))\\s+b3(\\w|\\s|-)*10?)|((tierr\\w+)|(medi\\w+))",
    ...
    EDIFICIO_ELECTRONICA ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))?((\\w|\\s)+)?electron?i?c?a?",
            R.drawable.tec_edificio_electronica),

    EDIFICIO_A4 (
            "(((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+a4)|((escuela)?((\\w|\\s)+)?matem?a?t?i?c?a?)",
            R.drawable.tec_edificio_a4),

    EDIFICIO_A5 ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+a5",
            R.drawable.tec_edificio_a5),

    EDIFICIO_B1 ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+b1",
            R.drawable.tec_edificio_b1),

    EDIFICIO_C1 ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+c1",
            R.drawable.tec_edificio_c1),

    EDIFICIO_D ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+d",
            R.drawable.tec_edificio_d),

    EDIFICIO_F ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+f2?",
            R.drawable.tec_edificio_f2),

    EDIFICIO_B3 ("((aula)|(edifi?c?i?o?)|(audito?r?i?o)|(labo?r?a?t?o?r?i?o?))\\s+b3?",
